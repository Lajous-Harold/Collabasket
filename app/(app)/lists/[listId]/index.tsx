...
export default function PersonalListDetailScreen() {
  ...
  const handleDetailedAdd = async (values: ItemFormValues) => {
    try {
      ...
      // Pour les champs etendus (storage_location, notes, price), on a besoin de
      // l'id retourne. useAddItem invalide deja la query, mais ces champs ne
      // sont pas pris en charge par useAddItem aujourd'hui — on patche apres.
      // Note : c'est suffisant pour la creation rapide. Si besoin de fields
      // complets a l'insertion, etendre useAddItem.
